...
(defn locations-updateSettings$
  ...
  {:pubsubNotificationSettings {},
   ...
   :analysisConfig {:annotatorSelector GoogleCloudContactcenterinsightsV1AnnotatorSelector,
...
(defn locations-issueModels-patch$
  ...
  {:modelType string,
   ...
   :updateTime string,
   :languageCode string,
   :inputDataConfig {:trainingConversationsCount string,
                     :medium string,
                     :filter string},
   :issueCount string,
...
(defn locations-conversations-patch$
  ...
  {:latestAnalysis {:requestTime string,
                    :name string,
                    :createTime string,
   ...
   :duration string,
   :updateTime string,
   :qualityMetadata {:agentInfo [GoogleCloudContactcenterinsightsV1ConversationQualityMetadataAgentInfo],
                     :waitDuration string,
                     :customerSatisfactionRating integer,
                     :menuPath string},
   :latestSummary {:text string,
                   :metadata {},
...
(defn locations-conversations-list$
  ...
  Optional parameters: pageToken, view, filter, orderBy, pageSize
...
(defn locations-conversations-ingest$
  ...
  {:parent string,
   ...
   :gcsSource {:metadataBucketUri string,
               :customMetadataKeys [string],
               :bucketObjectType string,
               :bucketUri string},
   :redactionConfig {:inspectTemplate string,
                     :deidentifyTemplate string},
   :conversationConfig {:agentChannel integer,
