...
(defn locations-jobs-create$
  ...
  Optional parameters: jobId, requestId
  ...
  {:labels {},
   ...
   :allocationPolicy {:location LocationPolicy,
                      ...
                      :tags [string]},
   :createTime string,
   :logsPolicy {:destination string,
                :logsPath string,
                :cloudLoggingOption CloudLoggingOption},
   :updateTime string,
   :taskGroups [{:taskCountPerNode string,
                 :parallelism string,
   ...
   :notifications [{:pubsubTopic string, :message Message}],
   :priority string,
   :status {:state string,
...
(defn locations-jobs-delete$
  ...
  Optional parameters: reason, requestId
...
(defn locations-state-report$
  ...
  {:metadata {:creationTime string,
   ...
   :agentInfo {:state string,
               ...
               :reportTime string,
               :taskGroupId string},
   :agentTimingInfo {:bootTime string,
