...
(defn locations-workloads-patch$
  ...
  {:provisionedResourcesParent string,
   ...
   :complianceStatus {:activeResourceViolationCount integer,
   ...
   :name string,
   :createTime string,
   :ekmProvisioningResponse {:ekmProvisioningErrorDomain string,
   ...
   :saaEnrollmentResponse {:setupStatus string, :setupErrors [string]},
...
(defn locations-workloads-analyzeWorkloadMove$
  ...
  Optional parameters: pageSize, assetTypes, project, pageToken
...
(defn locations-workloads-violations-list$
  ...
  Optional parameters: interval.startTime, pageToken, filter, interval.endTime, pageSize
