...
(defn locations-managementServers-create$
  ...
  Optional parameters: managementServerId, requestId
  ...
  {:description string,
   ...
   :networks [{:network string, :peeringMode string}],
   :workforceIdentityBasedOauth2ClientId {:firstPartyOauth2ClientId string,
