...
(defn patch$
  "https://cloud.google.com/support/docs/reference/rest/v2/cases/patch
...
(defn escalate$
  "https://cloud.google.com/support/docs/reference/rest/v2/cases/escalate
...
(defn get$
  "https://cloud.google.com/support/docs/reference/rest/v2/cases/get
...
(defn search$
  "https://cloud.google.com/support/docs/reference/rest/v2/cases/search
...
(defn create$
  "https://cloud.google.com/support/docs/reference/rest/v2/cases/create
...
(defn close$
  "https://cloud.google.com/support/docs/reference/rest/v2/cases/close
...
(defn list$
  "https://cloud.google.com/support/docs/reference/rest/v2/cases/list
...
(defn attachments-list$
  "https://cloud.google.com/support/docs/reference/rest/v2/cases.attachments/list
...
(defn comments-list$
  "https://cloud.google.com/support/docs/reference/rest/v2/cases.comments/list
...
(defn comments-create$
  "https://cloud.google.com/support/docs/reference/rest/v2/cases.comments/create
