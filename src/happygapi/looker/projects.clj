...
(defn locations-instances-patch$
  ...
  {:linkedLspProjectNumber string,
   ...
   :userMetadata {:additionalViewerUserCount integer,
   ...
   :denyMaintenancePeriod {:startDate Date,
                           :endDate Date,
                           :time TimeOfDay},
   :reservedRange string,
   :maintenanceWindow {:dayOfWeek string, :startTime TimeOfDay},
   :ingressPublicIp string,
   :customDomain {:domain string, :state string},
   :platformEdition string,
   :lastDenyMaintenancePeriod {:startDate Date,
                               :endDate Date,
                               :time TimeOfDay},
